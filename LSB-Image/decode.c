...
Status open_img_file(DecodeInfo *decInfo)
{
    ...
    //if it not returns the address print the error message
...
{
    printf("INFO: Decoding secret File Extenstion Size\n");
    char buffer[32];
...
Status decode_secret_file_extn(DecodeInfo *decInfo)
{
    ...
    printf("INFO: Output File not mentioned. Creating %s%s as default\n", decInfo -> secret_fname, decInfo -> extn_secret_file);
